...
suezXBannerAd.setPublisherId(YOUR_BANNER_PUBLISHER_ID_HERE); // 발급 받은 배너 publisher ID를 넣으세요.
suezXBannerAd.setInventoryId(YOUR_BANNER_INVENTORY_ID_HERE); // 발급 받은 배너 inventory ID를 넣으세요.
...
suezXInterstitialAd.setPublisherId(YOUR_INTERSTILTIAL_PUBLISHER_ID_HERE); // 발급 받은 인터스티셜 publisher ID를 넣으세요.
suezXInterstitialAd.setInventoryId(YOUR_INTERSTILTIAL_INVENTORY_ID_HERE); // 발급 받은 인터스티셜 inventory ID를 넣으세요.
